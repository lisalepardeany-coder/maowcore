...
const TEMPLATES = [
  ...
  // 12 ── Pixel Backrooms ──────────────────────────────────────────────────────
  {
    id: 'pixel-backrooms', label: 'Pixel Backrooms', emoji: '🟡', accent: 0xE8C84A,
    blurb: 'A Backrooms-themed game server with level progression roles and M.E.G. hierarchy',
    roles: roles(
      owner('🏛️ The Architect', 0xFFD700),
      [
        { name: '🔔 Game Updates', color: 0xE8C84A, mentionable: true, selfAssign: true, ping: true, emoji: '🔔', desc: 'Get pinged for Pixel Backrooms game updates.' },
        { name: '🎉 Events', color: 0xEB459E, mentionable: true, selfAssign: true, emoji: '🎉', desc: 'Get notified for in-game events & giveaways.' },
        vip('🌟 Verified Wanderer', 0x00CED1),
        { name: '⬛ Level 4 — The Apex', color: 0x2C2C2C, hoist: true, selfAssign: true },
        { name: '🟣 Level 3 — The Veteran', color: 0x9B59B6, hoist: true, selfAssign: true },
        { name: '🔴 Level 2 — The Survivor', color: 0xE74C3C, hoist: true, selfAssign: true },
        { name: '🟠 Level 1 — The Explorer', color: 0xE67E22, hoist: true, selfAssign: true },
      ],
      member('🟡 Level 0 — Wanderer', 0xE8C84A),
    ),
    categories: [
      { name: '📋 INFORMATION', perm: 'readOnly', channels: [
        { name: '📜-rules', rules: true },
        { name: '📣-announcements', perm: 'announce', config: 'announcementsChannelId', topic: 'Official Pixel Backrooms news & updates.' },
        { name: '🗺️-game-updates', perm: 'announce', config: 'liveChannelId', topic: 'Patch notes, new levels, and game news.' },
        { name: '🔔-bot-updates', perm: 'announce', config: 'updatesChannelId', topic: 'MaowCore bot changelogs & update notes.' },
        { name: '❓-faq', perm: 'readOnly', topic: 'Common questions about the game and server.' },
      ] },
      { name: '👋 WELCOME', perm: 'public', channels: [
        { name: '✅-verify', perm: 'readOnly', verify: true, topic: 'React ✅ to agree to the rules and enter the Backrooms.' },
        { name: '🏅-pick-roles', perm: 'readOnly', roleSelect: true, topic: 'Claim your level role and notification pings here.' },
        { name: '✧-welcome', perm: 'announce', config: 'welcomeChannelId', topic: 'New wanderers appear here.' },
        { name: '🚪-introductions', topic: 'Introduce yourself before you no-clip further.' },
      ] },
      { name: '🟡 THE BACKROOMS', perm: 'public', channels: [
        { name: '💬-general', topic: 'Main hub. Watch your step — the walls are watching.' },
        { name: '📸-level-photos', topic: 'Screenshots and artwork from the levels. SFW only.' },
        { name: '🔦-survival-tips', topic: 'Share your knowledge. Help other wanderers survive.' },
        { name: '😂-liminal-memes', topic: 'No-clipped into the meme dimension.' },
        { name: '🖼️-media', topic: 'Videos, art, and Backrooms content.' },
        { name: '📢-self-promo', topic: 'Share your content once per day.' },
      ] },
      { name: '🎮 PIXEL BACKROOMS GAME', perm: 'public', channels: [
        { name: '💡-suggestions', topic: 'Suggest new levels, items, mechanics, or features.' },
        { name: '🐛-bug-reports', topic: 'Found something broken? Describe steps to reproduce.' },
        { name: '🏆-leaderboard', topic: 'Top wanderers of Pixel Backrooms — share your stats.' },
        { name: '🤝-looking-for-group', topic: 'Find other players to explore with.' },
        { name: '🛒-trading', topic: 'In-game item trades — trade at your own risk.' },
      ] },
      { name: '🌟 VERIFIED LOUNGE', perm: 'vipOnly', channels: [
        { name: '💬-wanderers-lounge', topic: 'Exclusive chat for Verified Wanderers.' },
        { name: '🔮-early-access', topic: 'Sneak peeks & early game news for verified members.' },
      ] },
      BOT_CAT, STAFF_CAT,
      { name: '🔊 VOICE LEVELS', perm: 'voicePublic', voice: true, channels: [
        { name: '➕ Create Room', config: 'autoVoiceRoomId' },
        { name: '🟡 Level 0 — The Hub' },
        { name: '🟠 Exploration Team' },
        { name: '🎧 Music Lounge' },
        { name: '🛡️ M.E.G. Command', perm: 'staffVoice' },
        { name: '💤 AFK' },
      ] },
      STATS_CAT,
    ],
    rules: [
      ...BASE_RULES,
      { t: 'No level-role abuse', d: 'Only claim a level role if you've genuinely reached that point in the game. Faking progress will get the role removed.' },
      { t: 'No spoilers untagged', d: 'Tag story, lore, or endgame spoilers with ||spoiler bars|| so newer wanderers aren't ruined.' },
      { t: 'No cheats or exploits', d: 'Don't share or promote cheats, duplication glitches, or exploits that ruin the experience for others.' },
    ],
  },
];
